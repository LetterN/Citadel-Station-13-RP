...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_MERC = FREQ_SYNDICATE,
	RADIO_CHANNEL_RAIDER = FREQ_RAIDER,
	RADIO_CHANNEL_EXPLORER = FREQ_EXPLORER
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_SYNDICATE]" = RADIO_CHANNEL_MERC,
	"[FREQ_RAIDER]" = RADIO_CHANNEL_RAIDER,
	"[FREQ_EXPLORER]" = RADIO_CHANNEL_EXPLORER
))
