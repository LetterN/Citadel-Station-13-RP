...
/obj/machinery/telecomms/receiver/preset_right
	...
	freq_listening = list(FREQ_SCIENCE, FREQ_MEDICAL, FREQ_SUPPLY,
	FREQ_SERVICE, FREQ_COMMAND, FREQ_ENGINEERING, FREQ_SECURITY, FREQ_ENTERTAIN)
...
/obj/machinery/telecomms/receiver/preset_cent
	...
	freq_listening = list(FREQ_CENTCOM)
...
/obj/machinery/telecomms/bus/preset_four
	id = "Bus 4"
	network = "tcommsat"
	freq_listening = list(FREQ_ENGINEERING, FREQ_ENTERTAIN)
...
/obj/machinery/telecomms/server/presets/common
	id = "Common Server"
	freq_listening = list(FREQ_ENTERTAIN) // AI Private and Common
