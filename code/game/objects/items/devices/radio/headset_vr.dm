/obj/item/radio/headset/centcom
	...
	keyslot2 = new /obj/item/encryptionkey/ert // /obj/item/encryptionkey/headset_cent
...
/obj/item/radio/headset/mob_headset/can_receive(freq, level)
	return ..(freq, level, TRUE)

/obj/item/radio/headset/mob_headset/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, state = interactive_state)
